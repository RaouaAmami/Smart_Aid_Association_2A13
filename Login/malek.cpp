...
{
    QPdfWriter pdf("C:/Users/azers/OneDrive/Bureau/test_pdf/malek.pdf");
            ...
            {
                QDesktopServices::openUrl(QUrl::fromLocalFile("C:/Users/azers/OneDrive/Bureau/test_pdf/malek.pdf"));
